...
## [1.0.0-rc.4](https://github.com/LeagueToolkit/ltk-manager/releases/tag/v1.0.0-rc.4) - 2026-02-18

### Fixed

- move cslol-dll.dll and update PATCHER_DLL_NAME reference

## [1.0.0-rc.3](https://github.com/LeagueToolkit/ltk-manager/releases/tag/v1.0.0-rc.3) - 2026-02-18

### Fixed

- update release workflow to handle MSI and NSIS artifacts correctly

## [1.0.0-rc.2](https://github.com/LeagueToolkit/ltk-manager/releases/tag/v1.0.0-rc.2) - 2026-02-18

### Fixed

- improve logging in release workflow and refactor overlay path handling

## [1.0.0-rc.1](https://github.com/LeagueToolkit/ltk-manager/releases/tag/v1.0.0-rc.1) - 2026-02-18

### Other

- fix release workflow

## [1.0.0-beta.1](https://github.com/LeagueToolkit/ltk-manager/releases/tag/v1.0.0-beta.1) - 2026-02-18
...
- add mod core crate
- add error handling utils and react query integration
- add custom titlebar
